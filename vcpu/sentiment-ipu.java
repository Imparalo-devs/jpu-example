...
public class SentimentIPU {
    ...
    public static String Input_Security_Filter_Sanitization__iLU(String variableToCheck, int maxSize) {
        ...
        if (variableToCheck.matches(".*(?:base64|hex|decode|encode|eval|function|constructor|prototype|__proto__).*")) {
            return "";
        }
    ...
    public static Map<String, Object> runSentimentiPU(Object chatInput) {
        ...
        try {
            ...
            CompletableFuture<Void> allFutures = CompletableFuture.allOf(sentimentFuture, sanitizedFuture);
            allFutures.get();
    ...
    public static void writeInput(Map<String, Object> input) {
        ...
        // For example: writeInput(new HashMap<String, Object>() {{ put("chatInput", "Hello World"); }});
    ...
    public static void main(String[] args) {
        writeInput(new HashMap<String, Object>() {{ put("chatInput", "Hello World"); }});
